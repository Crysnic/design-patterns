...
namespace App\Middleware\Bahavioral\Strategy;

use App\Middleware\Bahavioral\Strategy\CommissionStrategies\CalculateCommissionStrategyInterface;
use App\Middleware\Bahavioral\Strategy\Entity\CommissionCondition;
